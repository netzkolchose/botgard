...
def BotGardBaseModel(
        ...
        custom_properties_model_name: Optional[str] = None,
) -> Type[models.Model]:
    """
    ...
    :param custom_properties_model_name: optional str,
        ...
        the model will have Many2Many fields like:
            ...
            custom_values_<type> = CustomPropertyValues<Type>Field(
                related_name="<custom_properties_model_name>_values_<type>"
            )
    ...
    if custom_properties_model_name:
        klass = CustomPropertiesBaseModel(related_name_model=custom_properties_model_name)
