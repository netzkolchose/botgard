...
urlpatterns = [
    ...
    re_path(r'^specimen/(?P<label_pk>\d+)/(?P<specimen_pk>\d+)/?$',         labels.label_herbarium_specimen, name='herbarium_specimen'),
    ...
    re_path(r'^random/specimen/(?P<label_pk>\d+)/?$',                       labels.label_herbarium_specimen, name='random_herbarium_specimen'),
